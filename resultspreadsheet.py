...
for i in range(1, NUM_ITERATIONS + 1):
    ...
    compiled_data.append({
        ...
        "DG 1 Bus": dg1_bus, "DG 1 Size (kW)": dg1_size,
        "DG 2 Bus": dg2_bus, "DG 2 Size (kW)": dg2_size,
        "DG 3 Bus": dg3_bus, "DG 3 Size (kW)": dg3_size,
        "Total DG Capacity (kW)": total_dg_capacity,
...
summary = pd.DataFrame([{
    ...
    "DG 1 Bus": "-", "DG 1 Size (kW)": df["DG 1 Size (kW)"].mean(),
    "DG 2 Bus": "-", "DG 2 Size (kW)": df["DG 2 Size (kW)"].mean(),
    "DG 3 Bus": "-", "DG 3 Size (kW)": df["DG 3 Size (kW)"].mean(),
    "Total DG Capacity (kW)": df["Total DG Capacity (kW)"].mean(),
